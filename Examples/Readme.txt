...
The output and plotting files are can be found in the subfolders such as “/Examples/Homogeneous model/Seismograms” or “/Examples/Homogeneous model/Snapshots” and the users are referred to the "Readme.txt" file inside for details.
